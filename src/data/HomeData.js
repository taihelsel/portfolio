        ...
        content: [
            {
                name: "SoundClout",
                content: [
                    { name: "Project Info", type: "text", content: `• Role - Full Stack Developer\r\n• Tech Used - React | Redux | React Router | Thunk | JavaScript | HTML5 \r\n| CSS3 | Node.Js | Express | MongoDB | Mongoose | ChartJS` },
                    { name: "Project Preview", type: "img", content: "soundclout.gif" },
                    { name: "Project GitHub", type: "html", content: "https://github.com/taihelsel/soundclout" },
                ],
                type: "folder",
            },
            {
